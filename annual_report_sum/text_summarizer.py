...
#MODEL_PATH_DICT['led_sum']['1']="/home/disk1/data/shuaiqi/sec-edgar/model/transformers411/LED_base/liquidity_8000_300/input_8_1000_300_without_seg_18_1/checkpoint-10300"
...
class Text_Summarizer(object):
    ...
    def __init__(
        ...
        if summarizer_name == "led_sum":
            #pdb.set_trace()

            #from transformers import PegasusForConditionalGeneration, PegasusTokenizer
            model_name = self.summarizer_dict['led_sum'][section_name]#['background']
            ...
            self.model = LEDForConditionalGeneration.from_pretrained(model_name).to(torch_device)
    ...
    def summarize(self, input_text, output_len=300, input_max_length = 4096):
        output_text = ""
